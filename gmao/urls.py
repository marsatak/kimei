...
urlpatterns = [
    ...
    path('home/appareils-distributeurs/', views.liste_appareils_distributeurs, name='liste_appareils_distributeurs'),
    path('api/appareils-distributeurs/', views.get_appareils_distributeurs_data,
